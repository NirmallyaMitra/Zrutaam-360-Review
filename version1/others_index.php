...
if (isset($_POST['submit_code'])) {
  $stmt1 = $conn->prepare("SELECT unique_code FROM candidate_emails WHERE unique_f_code = ?;");
  $stmt1->bind_param('s', $_POST['code_box']);
  $stmt1->execute();
  ...
  if ($result1) {
    ...
    $_SESSION['u_c'] = $_POST['code_box']; // je fill up korche
    ...
    <div id="" class="container">
      ...
      <div id="" class="seond-text">
        <p id="" class="lorem">
          ...
          praesentium consecteturLorem ipsum dolor sit amet consectetur
          adipisicing elit adipisicing elit.Omnis praesentium consecteturLorem
          ipsum dolor sit amet consectetur
        </p>
      </div>
      <div id="" class="form-div">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
          <label for="" class="text"><strong id="" class="emp">ENTER YOUR EMP CODE</strong></label>

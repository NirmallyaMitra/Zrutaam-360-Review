    ...
    <body>
        <div id="" class="main-container">
            <div id="" class="container">
                ...
                <form action="./database/others_question_answer_store.php" method="POST">
                    <?php
                    ...
                    ?>
                        ...
                        <?php
                        if ($i % 4 == 0 || $i == 40) { // Show comment box after every 4th and last question
                        ?>
                            <div id="commentForm<?php echo $i ?>" class="form comment-box">
                                <p class="q">Please leave your comment for these questions:</p>
                                <textarea id="commentText<?php echo $i ?>" rows="4" placeholder="Your comment..."></textarea><br>
                                <button type="button" class="submit-comment" data-step="<?php echo $i ?>">Submit Comment</button>
                            </div>
                    <?php
                        }
                        $i++;
        ...
        <script src="assets/JS/main_others.js"></script>
    </body>

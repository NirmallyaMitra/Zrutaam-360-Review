...
$unique_id = $_SESSION['uni_code'] ?? null;
$u_id = $_SESSION['u_c'] ?? null;
...
while ($row = $result->fetch_assoc()) {
    ...
    if (isset($_POST[$answer_key])) {
        ...
        $insertStmt->bind_param("ssii", $unique_id, $u_id, $question_id, $answer);
        $insertStmt->execute();
    }
    $i++;
}

...
?>
  ...
  <body>
    <form action="./database/question_answer_store.php?id=<?php echo $_SESSION['uni_code'] ?>" method="POST" class="form-container" id="feedbackForm">
      <h1>360-Degree Feedback Survey</h1>
      <p>
        Please provide your honest feedback on the manager's performance. Your

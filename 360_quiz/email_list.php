    ...
    <div id="" class="main-container">
      <form action="./database/add_emails.php?id=<?php echo $_SESSION['uni_code'] ?>" method="POST">
        <div id="" class="container">
          <div id="" class="email-div">
            <h1 id="" class="email">EMAIL</h1>
          </div>
          <label for="mail1" class="label-font change">Manager</label>
          <input type="text" name="email1" id="" class="text1 txt" required />

          <label for="email2" class="label-font change">Peer 1</label>
          <input type="text" name="email2" id="" class="text2 txt" required />

          <label for="email3" class="label-font change">Peer 2</label>
          <input type="text" name="email3" id="" class="text3 txt" required />

          <label for="email4" class="label-font change">Peer 3</label>
          <input type="text" name="email4" id="" class="text4 txt" required />

          <label for="email5" class="label-font change">Direct Reportee 1</label>
          <input type="text" name="email5" id="" class="text5 txt" required />

          <label for="email6" class="label-font change">Direct Reportee 2</label>
          <input type="text" name="email6" id="" class="text6 txt" required />

          <label for="email7" class="label-font change">Direct Reportee 3</label>
          <input type="text" name="email7" id="" class="text7 txt" required />

          <input type="submit" name="submit_email" style="background-color: #007aff; color:white; height:40px; border:none;" />
        </div>
      </form>
    </div>
  </body>

...
$sql = "select question from questions where category = 'TEAM BUILDING' order by id asc";
...
// Self Score
$sql1 = "select round(avg(answer),2) as av_my_score from candidate_response c INNER JOIN questions q on c.question_id = q.id where c.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id order by q.id;";
...
$sql2 = "select q.id, oi.RTL, q.category, count(o.answer), round(avg(o.answer),2) as avg_score from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id, oi.RTL order by q.id, oi.RTL";
...
$sql3 = "select count(o.answer), round(avg(o.answer), 2) as avg_score from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id order by q.id, oi.RTL";
...
$sql4 = "select q.id, oi.RTL, min(o.answer) from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id, oi.RTL order by q.id, oi.RTL";
...
$sql5 = "select q.id, oi.RTL, max(o.answer) from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id, oi.RTL order by q.id, oi.RTL";
...
$sql6 = "select q.id, oi.RTL, min(o.answer) from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id order by q.id, oi.RTL";
...
$sql7 = "select q.id, oi.RTL, max(o.answer) from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by q.id order by q.id, oi.RTL";
...
$sql8 = "select round(avg(o.answer),2) as avg_score from others_response o INNER JOIN questions q on o.question_id = q.id where o.unique_code = ? AND q.category = 'TEAM BUILDING'";
...
$sql9 = "select round(avg(o.answer),2) as avg_score from others_response o INNER JOIN questions q on o.question_id = q.id INNER JOIN others_info oi on o.u_id = oi.uc where o.unique_code = ? AND q.category = 'TEAM BUILDING' group by oi.RTL order by oi.RTL";
...
$sql10 = "select round(avg(answer),2) as av_my_score from candidate_response c INNER JOIN questions q on c.question_id = q.id where c.unique_code = ? AND q.category = 'TEAM BUILDING'";
  ...
  <div class="main-container">
    ...
    <div class="chart">
      <table id="table" class="table1" border="black">
        <tr>
          <td class="i">
            <p class="adaptibility">TEAM BUILDING</p>
